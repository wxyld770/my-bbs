...
var (
	...
	ErrAdminCannotManageAdmin         = New(http.StatusForbidden, 40304, "不能管理管理员账号")
	...
	ErrCurrentPasswordIncorrect       = New(http.StatusBadRequest, 40009, "原密码错误")
	ErrNewPasswordSameAsCurrent       = New(http.StatusBadRequest, 40010, "新密码不能与原密码相同")
